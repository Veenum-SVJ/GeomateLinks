...
import { LayoutDashboard, FileText, Briefcase, FolderKanban, Mail, Image, Settings, UserCircle, LogOut, Menu, X } from "lucide-react"
...
export default function AdminLayout() {
  ...
  return (
    <div className="flex min-h-screen w-full bg-background">
      ...
      <aside className={cn(
        "fixed inset-y-0 left-0 z-50 w-64 bg-white border-r transform transition-transform duration-200 ease-in-out lg:translate-x-0 lg:static lg:block",
