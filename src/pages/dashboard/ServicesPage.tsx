...
const services = [
  ...
  { icon: Map, title: "Mapping Services", description: "Comprehensive mapping solutions including satellite imagery and UAV photogrammetry." },
  ...
  { icon: Users, title: "Corporate Training", description: "Specialized training programs in GIS, remote sensing, and modern surveying." },
]
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">Add, edit, or remove your company's services here.</p>
      </div>
      <Card>
